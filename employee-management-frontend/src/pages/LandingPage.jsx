            ...
            <div className="px-12 mx-auto max-w-7xl">
                <div className="w-full mx-auto md:w-11/12 xl:w-9/12 md:text-center text-left">
                    <h1 className="mb-8 text-4xl font-extrabold leading-none tracking-normal text-slate-800 md:text-6xl md:tracking-tight">
                        <span>Start</span>{" "}
                        <span className="block w-full py-2 text-transparent bg-clip-text leading-12 bg-linear-to-r from-red-900 to-red-500 lg:inline">
                            managing employees
                        </span>{" "}
                    ...
                    <div className="mb-4 space-x-0 md:space-x-2 md:mb-8">
                        <Link
                            to="/login"
                            className="inline-flex items-center justify-center w-full px-6 py-2 mb-2 text-lg text-white bg-red-700 rounded-2xl sm:w-auto sm:mb-0"
                        >
                            Get Started <MoveRight />
                        </Link>
                        <Link
                            to="/register"
                            className="inline-flex items-center justify-center w-full px-6 py-2 mb-2 text-lg bg-gray-100 rounded-2xl sm:w-auto sm:mb-0"
                        >
                            Sign up <Lightbulb />
                        </Link>
                    </div>
